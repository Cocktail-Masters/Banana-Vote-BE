...
public interface BadgeRepository extends JpaRepository<Badge, Long> {
    ...
    Page<Badge> findByBadgeEndDateAfterAndIsSellingOrderByBadgePriceDec(LocalDate date, boolean isSelling,
            Pageable pageable);
    ...
    Page<Badge> findAllByOrderByBadgePriceDec(Pageable pageable);
