...
public class SeasonController {
    ...
    @Operation(summary = "시즌 정보 조회", description = "현재 시즌의 정보(겹치는 시즌이 여러 개 일 경우 먼저 시작한 첫번째 시즌) 또는 지금까지 모든 시즌의 정보 반환")
    @GetMapping
    public ResponseEntity<List<SeasonDto>> getSeasonInfo(
            @RequestParam(required = false, name = "current", defaultValue = "false") String isCurrent) {
